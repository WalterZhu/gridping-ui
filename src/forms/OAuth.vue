    ...
    <form @submit.prevent="saveOAuth">
        ...
        <div class="card mb-3">
            <div class="card-header text-capitalize">
                <font-awesome-icon @click="expanded.github = !expanded.github"
                                   :icon="expanded.github ? 'minus' : 'plus'" class="mr-2 pointer"/>
                Github Settings
            ...
            <div class="card-body" :class="{'d-none': !expanded.github}">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.gh_client_id" type="text" class="form-control" id="github_client"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.gh_client_secret" type="text" class="form-control" id="github_secret"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input v-bind:value="`${core.domain}/oauth/github`" type="text" class="form-control"
                                   id="gh_callback" readonly>
                            <div class="input-group-append copy-btn">
                                <button @click.prevent="copy(`${core.domain}/oauth/github`)"
        ...
        <div class="card mb-3">
            <div class="card-header">
                <font-awesome-icon @click="expanded.google = !expanded.google"
                                   :icon="expanded.google ? 'minus' : 'plus'" class="mr-2 pointer"/>
                Google Settings
            ...
            <div class="card-body" :class="{'d-none': !expanded.google}">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.google_client_id" type="text" class="form-control" id="google_client"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.google_client_secret" type="text" class="form-control" id="google_secret"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="github_secret" class="col-sm-4 col-form-label">Restrict Users</label>
                    <div class="col-sm-8">
                        <input v-model="oauth.google_users" type="text" class="form-control" id="google_users"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input v-bind:value="`${core.domain}/oauth/google`" type="text" class="form-control"
                                   id="google_callback" readonly>
                            <div class="input-group-append copy-btn">
                                <button @click.prevent="copy(`${core.domain}/oauth/google`)"
                                        class="btn btn-outline-secondary" type="button">Copy
                                </button>
                            </div>
                        </div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <font-awesome-icon @click="expanded.slack = !expanded.slack" :icon="expanded.slack ? 'minus' : 'plus'"
                                   class="mr-2 pointer"/>
                Slack Settings
            ...
            <div class="card-body" :class="{'d-none': !expanded.slack}">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.slack_client_id" type="text" class="form-control" id="slack_client"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.slack_client_secret" type="text" class="form-control" id="slack_secret"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.slack_users" type="text" class="form-control" id="slack_users"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input v-bind:value="`${core.domain}/oauth/slack`" type="text" class="form-control"
                                   id="slack_callback" readonly>
                            <div class="input-group-append copy-btn">
                                <button @click.prevent="copy(`${core.domain}/oauth/slack`)"
                                        class="btn btn-outline-secondary" type="button">Copy
                                </button>
                            </div>
                        </div>
        ...
        <div class="card mb-3">
            <div class="card-header">
                <font-awesome-icon @click="expanded.custom = !expanded.custom"
                                   :icon="expanded.custom ? 'minus' : 'plus'" class="mr-2 pointer"/>
            ...
            <div class="card-body" :class="{'d-none': !expanded.custom || !custom_enabled}">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.custom_client_id" type="text" class="form-control" id="custom_client"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.custom_client_secret" type="text" class="form-control" id="custom_secret"
                               required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <input v-model="oauth.custom_endpoint_auth" type="text" class="form-control"
                               id="custom_endpoint" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="custom_endpoint_token" class="col-sm-4 col-form-label">Token Endpoint</label>
                    <div class="col-sm-8">
                        <input v-model="oauth.custom_endpoint_token" type="text" class="form-control"
                               id="custom_endpoint_token" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                  ...
                  <span @click="oauth.custom_open_id = !!oauth.custom_open_id" class="switch switch-rd-gr float-right">
                    <input v-model="oauth.custom_open_id" type="checkbox" id="switch-custom-openid"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="input-group">
                            <input v-bind:value="`${core.domain}/oauth/custom`" type="text" class="form-control"
                                   id="custom_callback" readonly>
                            <div class="input-group-append copy-btn">
                                <button @click.prevent="copy(`${core.domain}/oauth/custom`)"
                                        class="btn btn-outline-secondary" type="button">Copy
                                </button>
                            </div>
                        </div>
